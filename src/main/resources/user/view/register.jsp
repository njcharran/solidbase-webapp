...
<html>
	...
	<body>
		...
		<div id="wrapper">
			...
			<div id="login_box" class="fillet_all" style="height:430px;">
				<div id="login_content_box" class="fillet_all">
					<div id="login_form_box" class="floatLeft">
						<form action="${BaseURL}users/register" method="post" id="login_form">
							...
							<input type="password" value="${ReqParamMap['user.rePwd'][0]}" name="user.rePwd" id="rePwd" class="input_style fillet_all validate[required,length[6,20]]"/>
							<span>${valError['user.rePwd']}</span>
							<div class="blank10"></div>
							...
							<div class="blank10 clear"></div>
							<input type="submit" id="login_button" value="注册"/>
							<span>${registerError }</span>
							<div class="blank10 clear"></div>
							<span style="font-size:12px; padding-left:5px;"><a href="${BaseURL}users/login">登录系统</a></span>
						</form>
					</div>
